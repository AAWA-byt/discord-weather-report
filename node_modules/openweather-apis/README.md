...
⚠ : :warning: New Version of the package (Node.js > 16) can be found at the new package domain [@cicciosgamino/openweather-apis](https://www.npmjs.com/package/@cicciosgamino/openweather-apis)
